...
<dspace:layout title="<%= title %>">
        ...
        <%-- Plugin para facebook. Adicionado por Anderson Queiroz 28/05/2015 --%>
        <div id="fb-root"></div>
        ...
        <%-- Plugin para linkedin. Adicionado por Anderson Queiroz 28/05/2015 --%>
        <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: pt_BR</script>
    
        <%-- Plugin para google plus. Adicionado por Anderson Queiroz 28/05/2015 --%>
    ...
    <div class="alert alert-success">
        ...
        <div class="fb-share-button" style="display: inline-flex; margin-top: 8px;" data-href="<%= HandleManager.getCanonicalForm(handle) %>" data-layout="button"></div>
    
        <script type="IN/Share" data-url="<%= HandleManager.getCanonicalForm(handle) %>"></script>
